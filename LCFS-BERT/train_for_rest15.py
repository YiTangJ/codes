    ...
    def _train(self, criterion, optimizer, train_data_loader, val_data_loader):
        ...
        for epoch in range(self.opt.num_epoch):
            ...
            if val_acc > max_val_acc:
                max_val_acc = val_acc
                if not os.path.exists('tyj_state_dict'):
                    os.mkdir('tyj_state_dict')
                path = 'tyj_state_dict/{0}_{1}_val_acc{2}'.format(self.opt.model_name, self.opt.dataset, round(val_acc, 4))
...
def main():
    ...
    parser.add_argument('--dataset', default='restaurant15', type=str, help='twitter, restaurant, laptop')
    ...
    parser.add_argument('--batch_size', default=64, type=int, help='try 16, 32, 64 for BERT models') # DefaultCPUAllocator: not enough memory:
...
'''
gpu-8K-2225
>> test_acc: 78.2288, test_f1: 52.2727
'''