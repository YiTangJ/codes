...
# from DGEDT.data_utils import ABSADatesetReader, ABSADataset, Tokenizer, build_embedding_matrix
# from DGEDT.bucket_iterator import BucketIterator
# from DGEDT.models import LSTM, ASGCN, ASCNN
# from DGEDT.dependency_graph import dependency_adj_matrix
...
class Inferer:
    ...
    def __init__(self, opt):
        ...
        fname = {
            ...
            'rest14': {
                'train': './datasets/semeval14Restaurant/restaurant_train.raw',
                'test': './datasets/semeval14Restaurant/restaurant_test.raw'
            },
            'semeval14_lap': {
                'train': './datasets/semeval14Restaurant/laptop_train.raw',
                'test': './datasets/semeval14Restaurant/laptop_test.raw'
            },
            'semeval15': {
